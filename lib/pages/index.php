...
<main class="dark:bg-slate-900 dark:text-slate-300">
    <section class="space-y-16 lg:space-y-20 px-4 lg:px-[10%] py-12 bg-slate-100 dark:bg-slate-800 scroll-mt-12" id="about">
        <div class="text-center w-[90%] mx-auto lg:w-[70%]">
            ...
            <p class="mt-2">
                <a class="text-sky-500 hover:underline underline-offset-4 hover:text-sky-600" href="">EasyBoard</a> was born out of the desire to make selling and renting of properties stress-free and convenient. It takes away the pain of going through third parties who sometimes extort propective buyers. With <a class="text-sky-500 hover:underline underline-offset-4 hover:text-sky-600" href="">EasyBoard</a> this process is simplified to just 3 easy steps:
            </p>
        </div>
    ...
    <section class="space-y-12 py-12 px-4 lg:px-[10%]">
        <div class="text-center w-[90%] mx-auto lg:w-[70%]">
            ...
            <p class="mt-2">
                At <a class="text-sky-500 hover:underline underline-offset-4 hover:text-sky-600" href="">EasyBoard</a>, we provide a wide variety of properties to match your need. This, and many more from the comfort of your
                home.
            </p>
        </div>
